...
export function SectionFooter() {
  ...
  return (
    <footer ref={rootRef} id="section-footer" className="bg-deepInk text-offWhite px-4 py-10 md:py-12">
      <div className="footer-content w-full max-w-4xl mx-auto flex flex-col items-center gap-4 text-center will-change-transform">
